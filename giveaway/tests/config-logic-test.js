...
function testConfigLogic() {
    ...
    console.log('   interactions: { likes: true, retweets: false, followers: false }');
    ...
    console.log('   filters: { requireLike: true, requireRetweet: false, requireFollow: false }');
    ...
    console.log(`   Users who are both retweeters AND followers: ${result3.map(u => u.username).join(', ')}`);
    ...
    console.log(`   Auto-collect: retweets=${shouldCollectRetweets}, followers=${shouldCollectFollowers}, likes=${shouldCollectLikes}`);
